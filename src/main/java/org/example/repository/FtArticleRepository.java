...
public interface FtArticleRepository {
    ...
    public List<FtArticle> getForPrintFtArticles(int boardId, int limitFrom, int limitTake, String searchKeywordTypeCode, String searchKeyword, String area, String avgLevel);
