...
import org.example.interceptor.NeedLoginInterceptor;
import org.example.interceptor.NeedLogoutInterceptor;
...
//				.addPathPatterns("/usr/member/doJoin");
        ...
        ir.addPathPatterns("/usr/article/foot_detail");
        ir.addPathPatterns("/usr/article/doModify");
        ir.addPathPatterns("/usr/article/doDelete");
        ir.addPathPatterns("/usr/member/doLogout");
        ir.addPathPatterns("/usr/reply/doWrite");
        ir.addPathPatterns("/usr/member/checkPw");
        ir.addPathPatterns("/usr/member/doModifyPw");
        ir.addPathPatterns("/usr/member/myPage");
