...
<div class="max-w-4xl mx-auto mt-10 p-8 bg-white rounded-2xl shadow-2xl">
    <h1 class="text-2xl font-bold mb-6 text-center text-green-700">용병 구하기 글 수정</h1>

    <form onsubmit="ArticleModify__submit(this); return false;" action="/usr/mercenaryArticle/doModify" method="POST">
        <input type="hidden" name="id" value="${mercenaryArticle.id}" />
        <input type="hidden" name="body" id="body" />

        <div class="mb-4">
            <label class="block mb-2 font-semibold">제목</label>
            <input name="title" type="text" value="${mercenaryArticle.title}" placeholder="제목을 입력하세요"
        ...
        <div class="mb-6">
            ...
            <!-- ✅ 초기값 저장용 textarea -->
            <textarea id="editor-init" style="display:none;"><c:out value="${mercenaryArticle.body}" /></textarea>
